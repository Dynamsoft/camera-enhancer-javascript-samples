import { CameraView, CameraEnhancer } from "@scannerproxy/dynamsoft-camera-enhancer";
...
class CameraEnhancerComponent extends React.Component {
  ...
  async componentDidMount() {
      try {
        ...
        await cameraView.setUIElement(this.elRef.current!);
